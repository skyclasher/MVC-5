namespace MvcMovie.Migrations
{
    ...
    public partial class Update : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Profiles", "DOB", c => c.DateTime(nullable: false));
            CreateIndex("dbo.Profiles", "UserId");
            AddForeignKey("dbo.Profiles", "UserId", "dbo.AspNetUsers", "Id");
            DropColumn("dbo.Profiles", "Date_of_Birth");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Profiles", "Date_of_Birth", c => c.DateTime(nullable: false));
